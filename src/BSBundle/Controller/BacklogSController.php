...
class BacklogSController extends Controller
{
    ...
    public function afficherpAction(Request $request)
    {
        ...
        $RAW_QUERY = "SELECT projets.nom_projet,equipe.nom_equipe,backlog_sprint.liste_sprint,backlog_sprint.id_bs,projets.id_projet FROM backlog_sprint INNER JOIN projets on projets.id_projet=backlog_sprint.id_projet INNER JOIN equipe on projets.ide_equipe=equipe.id_equipe";
