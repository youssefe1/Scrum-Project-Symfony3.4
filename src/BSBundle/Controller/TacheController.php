...
class TacheController extends Controller
{
    ...
    public function affAction()
    {
        ...
        $notif=$this->notif();
        $count=$this->count();
        return $this->render('BSBundle:BS:tache1.html.twig',array('b'=>$b,'a'=>$a,'notif'=>$notif,'count'=>$count));
    }
